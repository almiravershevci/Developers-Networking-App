...
import com.example.developernetworkingapp.data.repository.impl.ProjectJoinRepositoryFirestore
...
object AppContainer {
    ...
    val projectJoinRepository: ProjectJoinRepository by lazy { ProjectJoinRepositoryFirestore() }
